...
class Api::V1::Admin::IpBlocksController < Api::BaseController
  ...
  before_action -> { doorkeeper_authorize! :'admin:read', :'admin:read:ip_blocks' }, only: [:index, :show]
  before_action -> { doorkeeper_authorize! :'admin:write', :'admin:write:ip_blocks' }, except: [:index, :show]
