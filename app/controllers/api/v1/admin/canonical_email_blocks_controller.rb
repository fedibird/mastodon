...
class Api::V1::Admin::CanonicalEmailBlocksController < Api::BaseController
  ...
  before_action -> { doorkeeper_authorize! :'admin:read', :'admin:read:canonical_email_blocks' }, only: [:index, :show, :test]
  before_action -> { doorkeeper_authorize! :'admin:write', :'admin:write:canonical_email_blocks' }, except: [:index, :show, :test]
