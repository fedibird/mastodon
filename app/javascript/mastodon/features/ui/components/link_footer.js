...
import { invitesEnabled, limitedFederationMode, version, repository, source_url, statusPageUrl } from 'mastodon/initial_state';
    ...
    return (
      <div className='getting-started__footer'>
        <ul>
          ...
          {statusPageUrl && <li><a href={statusPageUrl} target='_blank' rel='noopener noreferrer'><FormattedMessage id='footer.status' defaultMessage='Status' /></a> · </li>}
