...
#  remote_admission_enabled :boolean
#  remote_admission_configured :boolean
#  remote_profile_version :integer
#  skipped_destination_cap_count :integer
#  skipped_origin_cap_count :integer
#  skipped_unavailable_count :integer
#  skipped_retry_after_count :integer
#  skipped_recent_429_count :integer
#  scanned_target_count  :integer
#  windows_scanned       :integer
#  scan_budget_exhausted_count :integer
#  mapped_origin_candidate_count :integer
#  adaptive_remote_shadow_enabled :boolean
#  adaptive_remote_configured :boolean
#  adaptive_profile_version :integer
#  adaptive_shadow_evaluated_current_claim_count :integer
#  adaptive_shadow_would_block_current_claim_count :integer
#  adaptive_shadow_destination_would_block_count :integer
#  adaptive_shadow_origin_would_block_count :integer
#  adaptive_runtime_unavailable_count :integer
#  adaptive_destination_cap_min :integer
#  adaptive_destination_cap_max :integer
#  adaptive_origin_cap_min :integer
#  adaptive_origin_cap_max :integer
#  load_snapshot         :jsonb
