...
class ActivityPub::Activity::Delete < ActivityPub::Activity
  ...
  def delete_person
    with_redis_lock("delete_in_progress:#{@account.id}", autorelease: 2.hours.seconds, raise_on_failure: false) do
  ...
  def expire_note
    ...
    with_redis_lock("delete_status_in_progress:#{object_uri}", autorelease: 5.minutes.seconds) do
